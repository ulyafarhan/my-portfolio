...
const props = defineProps({
  avatarUrl: { type: String, default: '<Placeholder for avatar URL>' },
  iconUrl: { type: String, default: '<Placeholder for icon URL>' },
  grainUrl: { type: String, default: '<Placeholder for grain URL>' },
  behindGradient: String,
  innerGradient: String,
  showBehindGradient: { type: Boolean, default: true },
  className: { type: String, default: '' },
  enableTilt: { type: Boolean, default: true },
  miniAvatarUrl: String,
  name: { type: String, default: 'Javi A. Torres' },
  title: { type: String, default: 'Software Engineer' },
  handle: { type: String, default: 'javicodes' },
...
.pc-user-info {
  ...
  background-color: var(--color-surface, #191A23);
...
@media (max-width: 480px) {
  ...
  .pc-details h3 { font-size: min(3.5svh, 2em); }
  .pc-details p { font-size: 12px; top: -8px; }
  .pc-user-info { bottom: 12px; left: 12px; right: 12px; padding: 8px 10px; border-radius: 50px; }
...
@media (max-width: 320px) {
  ...
  .pc-details h3 { font-size: min(3svh, 1.5em); }
  .pc-details p { font-size: 11px; }
  .pc-user-info { padding: 6px 8px; border-radius: 50px; }
  .pc-mini-avatar { width: 20px; height: 20px; }
